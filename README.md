# NODE-DOCUMENT-STORAGE-LEVELDB [![Build Status](https://secure.travis-ci.org/grimen/node-document-storage-leveldb.png)](http://travis-ci.org/grimen/node-document-storage-leveldb)
